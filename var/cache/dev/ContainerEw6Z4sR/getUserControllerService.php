...
class getUserControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.x9zd309'] ?? $container->load('get_ServiceLocator_X9zd309Service'))->withContext('App\\Controller\\UserController', $container));
